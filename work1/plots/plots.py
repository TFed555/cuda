...
def plot():
    ...
    fig.add_trace(go.Scatter(x=[obj['number_elements'] for obj in objs_GPUCore],
                             y=[obj['real_time'] for obj in objs_GPUCore], name="CPUManual"))
    fig.add_trace(go.Scatter(x=[obj['number_elements'] for obj in objs_GPUCore],
                             y=[obj['real_time'] for obj in objs_GPUCore], name="GPUCoreManual"))
    ...
    fig.add_trace(go.Scatter(x=[obj['number_elements'] for obj in objs_GPUFull],
                             y=[obj['real_time'] for obj in objs_GPUFull], name="GPU"))
    fig.add_trace(go.Scatter(x=[obj['number_elements'] for obj in objs_GPUCore],
